...
var retError, result;
var fragment, requestId, generated_resource_name;
...
describe('handler', function () {
  ...
  context('Single Port Inbound', function () {
    ...
    it('Check that correct type is set for entry', function () {
      var expected_resource_type = 'AWS::EC2::NetworkAclEntry';
      assert.equal(result.fragment.Resources[generated_resource_name].Type, expected_resource_type);
    });
    it('Check that correct properties are set for entry', function () {
      var properties = result.fragment.Resources[generated_resource_name].Properties;
  ...
  context('Single Port IPv6 Inbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicInbound100';
      fragment = {"Resources": {"NaclPublic": {"Type": "AWS::EC2::NetworkAcl", "Properties": { "Inbound": ["100,6,allow,2406:da1c:a9e:b901::/64,443"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
    ...
    it('Check that correct properties are set for entry', function () {
      var properties = result.fragment.Resources[generated_resource_name].Properties;
      assert.deepEqual(properties['Ipv6CidrBlock'], '2406:da1c:a9e:b901::/64');
      assert.deepEqual(properties['Protocol'], '6');
      assert.deepEqual(properties['Egress'], false);
      assert.deepEqual(properties['NetworkAclId'], { Ref: 'NaclPublic' });
      assert.deepEqual(properties['RuleAction'], 'allow');
  ...
  context('Multiple Port Inbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicInbound100';
      fragment = {"Resources": { "NaclPublic": { "Type": "AWS::EC2::NetworkAcl", "Properties": { "Inbound": [ "100,6,allow,0.0.0.0/0,443-446"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
    ...
    it('Check that correct properties are set for entry', function () {
      ...
      assert.deepEqual(properties['RuleNumber'], '100');
      assert.deepEqual(properties['PortRange']['From'], '443');
      assert.deepEqual(properties['PortRange']['To'], '446');
    });
  });
  context('All Ports Inbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicInbound100';
      fragment = {"Resources": { "NaclPublic": { "Type": "AWS::EC2::NetworkAcl", "Properties": { "Inbound": [ "100,6,allow,0.0.0.0/0,-1"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
    ...
    it('Check that correct properties are set for entry', function () {
      ...
      assert.deepEqual(properties['RuleAction'], 'allow');
      assert.deepEqual(properties['RuleNumber'], '100');
      assert.deepEqual(properties['PortRange']['From'], '-1');
      assert.deepEqual(properties['PortRange']['To'], '-1');
    });
  });
  ...
  context('Single Port IPv6 Outbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicOutbound100';
      fragment = {"Resources": {"NaclPublic": {"Type": "AWS::EC2::NetworkAcl", "Properties": { "Outbound": ["100,6,allow,2406:da1c:a9e:b901::/64,443"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
  ...
  context('Multiple Port Inbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicOutbound100';
      fragment = {"Resources": { "NaclPublic": { "Type": "AWS::EC2::NetworkAcl", "Properties": { "Outbound": [ "100,6,allow,0.0.0.0/0,443-446"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
  ...
  context('All Ports Outbound', function () {
    before('Invoke function', function (done) {
      generated_resource_name = 'NaclPublicOutbound100';
      fragment = {"Resources": { "NaclPublic": { "Type": "AWS::EC2::NetworkAcl", "Properties": { "Outbound": [ "100,6,allow,0.0.0.0/0,-1"]}}}};
      requestId = "testRequest";
      var event = {
        'region': 'ap-southeast-2',
        'requestId': requestId,
